...
{
    public partial class XINV_NAT_Rpt008_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        List<XINV_NAT_Rpt008_Info> lst_reporte = new List<XINV_NAT_Rpt008_Info>();
        XINV_NAT_Rpt008_Bus bus_reporte = new XINV_NAT_Rpt008_Bus();
        ...
        public XINV_NAT_Rpt008_Rpt()
        {
            InitializeComponent();
        }

        private void XINV_NAT_Rpt008_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
