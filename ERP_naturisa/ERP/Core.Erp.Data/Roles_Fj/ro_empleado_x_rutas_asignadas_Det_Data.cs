...
{
   public class ro_empleado_x_rutas_asignadas_Det_Data
   {
       string MensajeError = "";
           ...
           try
           {
               ...
               using (EntityRoles_FJ db = new EntityRoles_FJ())
               {
                   foreach (var info in lista)
                   {
                       ...
                       ro_empleado_x_rutas_asignadas_Det add = new ro_empleado_x_rutas_asignadas_Det();
                       add.IdEmpresa = info.IdEmpresa;
                       add.IdNomina_Tipo = info.IdNomina_Tipo;
                       add.IdRuta = info.id_ruta;
                       add.IdEmpleado = info.IdEmpleado;
                       add.secuencia = info.secuencia;
                       db.ro_empleado_x_rutas_asignadas_Det.Add(add);
                       db.SaveChanges();
                       sec++;
                   }
                   return true;
