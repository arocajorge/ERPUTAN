  ...
  public  class in_Ing_Egr_Inven_det_Data
    {
          ...
          try
          {
              ...
              using (SqlConnection connection = new SqlConnection(ConexionERP.GetConnectionString()))
              {
                  ...
                  string query = "select a.IdEmpresa, a.IdSucursal, a.IdMovi_inven_tipo, a.IdNumMovi, a.Secuencia,"
                                ...
                                + " a.IdPunto_cargo_grupo, a.IdPunto_cargo, a.IdMotivo_Inv, a.IdEstadoAproba, a.IdEmpresa_inv, a.IdSucursal_inv, a.IdBodega_inv, a.IdMovi_inven_tipo_inv, a.IdNumMovi_inv, a.Secuencia_inv,"
                                + " a.dm_cantidad_sinConversion, a.dm_cantidad, b.pr_codigo, a.IdCentroCosto, a.IdCentroCosto_sub_centro_costo, a.IdCentroCosto+'-'+a.IdCentroCosto_sub_centro_costo as IdRegistro"
                  ...
                  while (reader.Read())
                  {
                      lM.Add(new in_Ing_Egr_Inven_det_Info
                      {
                          ...
                          dm_observacion = Convert.ToString(reader["dm_observacion"]),
                          ...
                          IdUnidadMedida_sinConversion = Convert.ToString(reader["IdUnidadMedida_sinConversion"]),
                          mv_costo_sinConversion = Convert.ToDouble(reader["mv_costo_sinConversion"]),
                          IdEmpresa_oc =  string.IsNullOrEmpty(reader["IdEmpresa_oc"].ToString()) ? null : (int?)(reader["IdEmpresa_oc"]),
                          IdSucursal_oc = string.IsNullOrEmpty(reader["IdSucursal_oc"].ToString()) ? null : (int?)reader["IdSucursal_oc"],
                          IdOrdenCompra = string.IsNullOrEmpty(reader["IdOrdenCompra"].ToString()) ? null : (decimal?)reader["IdOrdenCompra"],
                          Secuencia_oc = string.IsNullOrEmpty(reader["Secuencia_oc"].ToString()) ? null : (int?)reader["Secuencia_oc"],
                          ...
                          IdEmpresa_inv = string.IsNullOrEmpty(reader["IdEmpresa_inv"].ToString()) ? null : (int?)reader["IdEmpresa_inv"],
                          IdSucursal_inv = string.IsNullOrEmpty(reader["IdSucursal_inv"].ToString()) ? null : (int?)reader["IdSucursal_inv"],
                          IdBodega_inv = string.IsNullOrEmpty(reader["IdBodega_inv"].ToString()) ? null : (int?)reader["IdBodega_inv"],
                          IdMovi_inven_tipo_inv = string.IsNullOrEmpty(reader["IdMovi_inven_tipo_inv"].ToString()) ? null : (int?)reader["IdMovi_inven_tipo_inv"],
                          IdNumMovi_inv = string.IsNullOrEmpty(reader["IdNumMovi_inv"].ToString()) ? null : (decimal?)reader["IdNumMovi_inv"],
                          secuencia_inv = string.IsNullOrEmpty(reader["secuencia_inv"].ToString()) ? null : (int?)reader["secuencia_inv"],
                          ...
                          CantidadAnterior = Math.Abs(Convert.ToDouble(reader["dm_cantidad"])),
                      });
                  }
                  reader.Close();
              }
      ...
      public in_Ing_Egr_Inven_det_Info Get_Info_Ing_Egr_Inven_det_x_Movi_Inven(int IdEmpresa_inv, int IdSucursal_inv, int IdBodega_Inv, int IdMovi_inven_tipo_inv ,decimal IdNumMovi)
      {
          try
          {
              ...
              vwin_Ing_Egr_Inven_det item = OEInventario.vwin_Ing_Egr_Inven_det.FirstOrDefault(q => q.IdEmpresa_inv == IdEmpresa_inv && q.IdSucursal_inv == IdSucursal_inv
              ...
              info = new in_Ing_Egr_Inven_det_Info
              {
                  ...
                  IdMovi_inven_tipo = (int)item.IdMovi_inven_tipo,
