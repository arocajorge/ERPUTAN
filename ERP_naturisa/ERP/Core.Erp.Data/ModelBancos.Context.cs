...
namespace Core.Erp.Data
{
    ...
    public partial class EntitiesBanco : DbContext
    {
        ...
        public virtual ObjectResult<SPBAN_TransaccionesAConciliar_Result> SPBAN_TransaccionesAConciliar(Nullable<int> idEmpresa, string idCtaCble, Nullable<System.DateTime> fechaCorte, Nullable<decimal> idConciliacion)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SPBAN_TransaccionesAConciliar_Result>("EntitiesBanco.SPBAN_TransaccionesAConciliar", idEmpresaParameter, idCtaCbleParameter, fechaCorteParameter, idConciliacionParameter);
        }
    }
}
