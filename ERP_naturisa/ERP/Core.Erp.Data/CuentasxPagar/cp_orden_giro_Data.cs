        ...
        public liquidacionCompra get_xml(int IdEmpresa,int IdSucursal, int IdTipoCbte_Ogiro, decimal IdCbteCble_Ogiro)
            {
                ...
                try
                {
                    ...
                    using (EntitiesCuentasxPagar context = new EntitiesCuentasxPagar())
                    {
                        var item = context.vwcp_orden_giro_liqui_compra_fact_elect.Where(v => v.IdEmpresa == IdEmpresa
                        && v.IdSucursal==IdSucursal
                        && v.IdTipoCbte_Ogiro==IdTipoCbte_Ogiro
                        && v.IdCbteCble_Ogiro==IdCbteCble_Ogiro).First();
                        ...
                        if (item == null)
                            ...
                            var facturas_detalle = context.vwcp_orden_giro_det_liqui_comp_fac_elect.Where(v => v.IdEmpresa == item.IdEmpresa
