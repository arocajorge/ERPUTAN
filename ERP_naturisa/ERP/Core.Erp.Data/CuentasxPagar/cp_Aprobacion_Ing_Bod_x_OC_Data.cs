           ...
           try
           {
               try
               {
                   using (EntitiesCuentasxPagar CxP = new EntitiesCuentasxPagar())
                   {
                       ...
                       Address.Observacion = (Info.Observacion ?? "").Length > 350 ? Info.Observacion.Substring(0, 349) : Info.Observacion;
                       ...
                       Address.co_FechaVctoAutorizacion = Info.co_FechaVctoAutorizacion ?? DateTime.Now.Date;
