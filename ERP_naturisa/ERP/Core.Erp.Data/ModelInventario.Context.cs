...
namespace Core.Erp.Data
{
    ...
    public partial class EntitiesInventario : DbContext
    {
        ...
        public virtual int spSys_Inv_Recosteo_Inventario_x_producto(Nullable<int> idEmpresa, Nullable<int> idSucursal, Nullable<int> idBodega, Nullable<decimal> idProducto, Nullable<System.DateTime> fecha_ini, Nullable<int> cant_Decimales)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spSys_Inv_Recosteo_Inventario_x_producto", idEmpresaParameter, idSucursalParameter, idBodegaParameter, idProductoParameter, fecha_iniParameter, cant_DecimalesParameter);
        }
    
        public virtual int spINV_aprobacion_movimiento(Nullable<int> idEmpresa, Nullable<int> idSucursal, Nullable<int> idMovi_inven_tipo, Nullable<int> idBodega, Nullable<decimal> idNumMovi)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spINV_aprobacion_movimiento", idEmpresaParameter, idSucursalParameter, idMovi_inven_tipoParameter, idBodegaParameter, idNumMoviParameter);
        }
    
        public virtual ObjectResult<spINV_relaciones_no_parametrizadas_Result> spINV_relaciones_no_parametrizadas(Nullable<int> idEmpresa, Nullable<System.DateTime> fecha_ini, Nullable<System.DateTime> fecha_fin)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
        ...
        public virtual ObjectResult<SPINV_GetMovimientosPorContabilizar_Result> SPINV_GetMovimientosPorContabilizar(Nullable<int> idEmpresa, Nullable<System.DateTime> fechaIni, Nullable<System.DateTime> fechaFin)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
