...
{
    public class vwAca_Matricula_x_Estudiante_Data
    {
        public List<vwAca_Matricula_x_Estudiante_Info> Get_List_Matricula_x_Estudiante(int IdInstitucion)
        {
            try
            {
                ...
                {
                    var context = from c in Base.vwAca_Matricula_x_Estudiante
                    ...
                    if (context != null)
                    {
                        ...
                        {
                            vwAca_Matricula_x_Estudiante_Info Matricula_x_Estudiante_Info = new vwAca_Matricula_x_Estudiante_Info();
                            Matricula_x_Estudiante_Info.IdCurso = item.IdCurso;

                            Matricula_x_Estudiante_Info.IdInstitucion = item.IdCurso;
