...
namespace Core.Erp.Data
{
    ...
    public partial class EntityRoles_FJ : DbContext
    {
        ...
        public virtual ObjectResult<spro_empleados_sin_registro_asistencia_Result> spro_empleados_sin_registro_asistencia(Nullable<int> idempres, Nullable<System.DateTime> fecha, Nullable<int> idNomina_Tipo, Nullable<int> idDivision)
        {
            var idempresParameter = idempres.HasValue ?
                new ObjectParameter("Idempres", idempres) :
                new ObjectParameter("Idempres", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spro_empleados_sin_registro_asistencia_Result>("spro_empleados_sin_registro_asistencia", idempresParameter, fechaParameter, idNomina_TipoParameter, idDivisionParameter);
        }
    }
}
