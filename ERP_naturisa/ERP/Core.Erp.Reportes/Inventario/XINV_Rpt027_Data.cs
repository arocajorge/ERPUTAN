...
namespace Core.Erp.Reportes.Inventario
{
    public class XINV_Rpt027_Data
    {
        ...
        public List<XINV_Rpt027_Info> Get_List(DateTime Fecha_desde, DateTime Fecha_hasta, int IdEmpresa, int IdSucursal, List<int> lst_bodega, decimal IdProducto, string idUsuario, bool No_mostrar_valores_en_0, bool Mostrar_detallado, bool MostrarNegativos)
        {
            try
            {
                ...
                using (Entities_Inventario_General context = new Entities_Inventario_General())
                {
                    ...
                    {
                        var lst = context.spINV_Rpt027(IdEmpresa, IdSucursal_ini, IdSucursal_fin, item_bodega, item_bodega, IdProducto_ini, IdProducto_fin, Fecha_desde, Fecha_hasta, idUsuario, No_mostrar_valores_en_0, Mostrar_detallado, MostrarNegativos).ToList();
