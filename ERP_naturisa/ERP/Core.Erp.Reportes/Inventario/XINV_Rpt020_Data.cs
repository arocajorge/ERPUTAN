...
namespace Core.Erp.Reportes.Inventario
{
    public class XINV_Rpt020_Data
    {
        public List<XINV_Rpt020_Info> GetList(int IdEmpresa, decimal IdProducto, DateTime FechaIni, DateTime FechaFin, string IdCentroCosto, int IdSucursal, int IdBodega)
        {
            try
            {
                List<XINV_Rpt020_Info> Lista = new List<XINV_Rpt020_Info>();
                ...
                using (SqlConnection connection = new SqlConnection(ConexionERP.GetConnectionString()))
                {
                    ...
                    string query = "SELECT a.IdEmpresa, a.IdSucursal, a.IdMovi_inven_tipo, a.IdNumMovi, a.Secuencia, a.IdBodega, b.cm_fecha, a.IdProducto, d.pr_descripcion,"
                                ...
                                + " h.tm_descripcion, i.bo_Descripcion, abs(a.dm_cantidad) dm_cantidad, a.IdEstadoAproba, j.Descripcion as NomUnidadMedida, abs(a.dm_cantidad) * a.mv_costo as mv_costo"
                    ...
                    while (reader.Read())
                    {
                        Lista.Add(new XINV_Rpt020_Info
                        {
