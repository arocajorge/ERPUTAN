    ...
    public partial class XINV_Rpt027_Rpt_detallado : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void XINV_Rpt027_Rpt_detallado_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                Lista = bus_Rpt.Get_List(Convert.ToDateTime(P_Fecha_desde.Value), Convert.ToDateTime(P_Fecha_hasta.Value), param.IdEmpresa, Convert.ToInt32(P_IdSucursal.Value), lst_bodega, Convert.ToDecimal(P_IdProducto.Value),param.IdUsuario,Convert.ToBoolean(P_Mostrar_registros_0.Value), Mostrar_detallado,MostrarNegativos);
