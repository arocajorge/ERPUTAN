...
{
    public partial class frmRo_Asignacion_Ruta_x_empleado_Mant : Form
    {
        public frmRo_Asignacion_Ruta_x_empleado_Mant()
        {
            InitializeComponent();
        }
        ...
        List<ro_ruta_Info> lista_rutas = new List<ro_ruta_Info>();
        ro_ruta_Bus bus_rutas = new ro_ruta_Bus();
        ...
        public void Cargar_Datos()
        {
            try
            {
                ...
                lista_rutas = bus_rutas.Get_List_Ruta(param.IdEmpresa);
                cmb_parametros_variable.Properties.DataSource = lista_rutas;
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ro_ruta_Info info_parametrso_x_empleado = new ro_ruta_Info();

                ro_ruta_Info info = (ro_ruta_Info)cmb_parametros_variable.Properties.View.GetFocusedRow();
                if (info != null)
                {
                    var query = lista_zonas_x_empleados.Where(v => v.id_ruta == info.IdRuta);
                    if (query.Count() > 0)
                    {
                    ...
                    else
                    {
                        ...
                        info_de.ru_descripcion = info.ru_descripcion;
                        info_de.id_ruta = info.IdRuta;
