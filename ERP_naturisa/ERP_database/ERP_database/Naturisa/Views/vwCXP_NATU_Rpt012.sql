...
FROM     (SELECT dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, dbo.cp_TipoDocumento.Codigo, dbo.cp_TipoDocumento.Descripcion, 
                                    dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre, dbo.tb_persona.pe_cedulaRuc, dbo.cp_orden_giro.co_serie AS serie_fact, dbo.cp_orden_giro.co_factura AS num_factura, 
                  ...
                  FROM      dbo.cp_codigo_SRI INNER JOIN
                                    ...
                                    dbo.cp_retencion.IdCbteCble_Ogiro = dbo.cp_orden_giro.IdCbteCble_Ogiro AND dbo.cp_retencion.IdTipoCbte_Ogiro = dbo.cp_orden_giro.IdTipoCbte_Ogiro
                  WHERE   (dbo.cp_orden_giro.Estado = 'A') and dbo.cp_orden_giro.co_vaCoa = 'S'
                  /*and cp_orden_giro.IdEmpresa = 3 and cp_orden_giro.IdCbteCble_Ogiro = 248*/ UNION
                  SELECT cp_nota_DebCre.IdEmpresa, cp_nota_DebCre.IdTipoCbte_Nota, cp_nota_DebCre.IdCbteCble_Nota, '04', 'N/C', 'N/C Compras' AS Descripcion, cp_proveedor.IdProveedor, cp_proveedor.pr_nombre, tb_persona.pe_cedulaRuc, 
                                    cp_nota_DebCre.cn_serie1 + '-' + cp_nota_DebCre.cn_serie2 AS serie_fact, cp_nota_DebCre.cn_Nota AS num_factura, cp_nota_DebCre.cn_fecha, cp_nota_DebCre.cn_subtotal_iva AS subtotal_iva, 
                  ...
                  UNION
                  SELECT cp_nota_DebCre.IdEmpresa, cp_nota_DebCre.IdTipoCbte_Nota, cp_nota_DebCre.IdCbteCble_Nota, '05', 'N/D', 'N/D Compras' AS Descripcion, cp_proveedor.IdProveedor, cp_proveedor.pr_nombre, tb_persona.pe_cedulaRuc, 
                                    cp_nota_DebCre.cn_serie1 + '-' + cp_nota_DebCre.cn_serie2 AS serie_fact, cp_nota_DebCre.cn_Nota AS num_factura, cp_nota_DebCre.cn_fecha, cp_nota_DebCre.cn_subtotal_iva AS subtotal_iva, 
                                    cp_nota_DebCre.cn_subtotal_siniva AS subtotal_sin_iva, cp_nota_DebCre.cn_valoriva AS valor_iva, cp_nota_DebCre.cn_Autorizacion, NULL AS serie_ret, NULL AS NumRetencion, NULL AS re_baseRetencion, NULL 
                                    AS re_Porcen_retencion, NULL AS re_valor_retencion, NULL AS re_Codigo_impuesto, 0 AS RIVA_0, 0 AS RIVA_10, 0 AS RIVA_20, 0 AS RIVA_30, 0 AS RIVA_70, 0 AS RIVA_100, 0 AS RTF_0, 0 AS RTF_0_1, 0 AS RTF_1, 0 AS RTF_2, 
