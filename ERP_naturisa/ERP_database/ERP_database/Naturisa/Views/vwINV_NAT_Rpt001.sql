...
SELECT Guia.IdEmpresa, Guia.IdGuia, 'con_oc' AS TipoDetalle, Guia.secuencia, Guia.IdEmpresa_OC, Guia.IdSucursal_OC, Guia.IdOrdenCompra_OC, Guia.Secuencia_OC, Guia.observacion, prod.IdProducto, Guia.Cantidad_enviar, 
                  ...
                  dbo.in_Catalogo.Nombre AS nom_motivo, prod.pr_codigo, dbo.in_Guia_x_traspaso_bodega.Placa
FROM     dbo.in_Guia_x_traspaso_bodega_det AS Guia INNER JOIN
                  dbo.com_ordencompra_local_det AS oc_det ON Guia.IdEmpresa_OC = oc_det.IdEmpresa AND Guia.IdSucursal_OC = oc_det.IdSucursal AND Guia.IdOrdenCompra_OC = oc_det.IdOrdenCompra AND 
                  ...
                  dbo.in_Guia_x_traspaso_bodega ON Guia.IdEmpresa = dbo.in_Guia_x_traspaso_bodega.IdEmpresa AND Guia.IdGuia = dbo.in_Guia_x_traspaso_bodega.IdGuia INNER JOIN
                  ...
                  dbo.in_Catalogo ON dbo.in_Guia_x_traspaso_bodega.IdMotivo_Traslado = dbo.in_Catalogo.IdCatalogo LEFT OUTER JOIN
                  dbo.tb_sucursal ON dbo.in_Guia_x_traspaso_bodega.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.in_Guia_x_traspaso_bodega.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND 
                  dbo.in_Guia_x_traspaso_bodega.IdSucursal_Partida = dbo.tb_sucursal.IdSucursal LEFT OUTER JOIN
                  dbo.tb_sucursal AS tb_sucursal_1 ON dbo.in_Guia_x_traspaso_bodega.IdEmpresa = tb_sucursal_1.IdEmpresa AND dbo.in_Guia_x_traspaso_bodega.IdEmpresa = tb_sucursal_1.IdEmpresa AND 
                  dbo.in_Guia_x_traspaso_bodega.IdSucursal_Llegada = tb_sucursal_1.IdSucursal
UNION ALL
SELECT dbo.in_Guia_x_traspaso_bodega_det_sin_oc.IdEmpresa, dbo.in_Guia_x_traspaso_bodega_det_sin_oc.IdGuia, 'sin_oc' AS TipoDetalle, dbo.in_Guia_x_traspaso_bodega_det_sin_oc.secuencia, NULL AS Expr1, NULL AS Expr2, NULL 
                  ...
                  dbo.in_Guia_x_traspaso_bodega.Hora_Traslado, dbo.in_Guia_x_traspaso_bodega.Hora_Llegada, dbo.in_Catalogo.Nombre AS nom_motivo, NULL AS Expr7, dbo.in_Guia_x_traspaso_bodega.Placa
