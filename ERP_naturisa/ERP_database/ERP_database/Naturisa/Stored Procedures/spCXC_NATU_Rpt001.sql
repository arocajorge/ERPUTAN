...
SELECT      dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, fa_factura.vt_tipoDoc,  
			...
			--format(ROUND(dbo.vwfa_factura_SubTotal_Iva_total.vt_total,2),'############.00') Valor_operacion,
...
FROM            tb_Catalogo INNER JOIN
                         ...
                         tb_parroquia ON fa_cliente.IdCiudad = tb_parroquia.IdCiudad_Canton AND fa_cliente.IdParroquia = tb_parroquia.IdParroquia LEFT OUTER JOIN
