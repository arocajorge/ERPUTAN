...
AS
SELECT        Fj_servindustrias.fa_registro_unidades_x_equipo.IdEmpresa, Fj_servindustrias.fa_registro_unidades_x_equipo.IdPeriodo, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdCentroCosto, Fj_servindustrias.fa_registro_unidades_x_equipo.IdCentroCosto_sub_centro_costo, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.Fecha, Fj_servindustrias.fa_registro_unidades_x_equipo.Observacion, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdUsuarioUltMod, Fj_servindustrias.fa_registro_unidades_x_equipo.Fecha_UltMod, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdUsuarioUltAnu, Fj_servindustrias.fa_registro_unidades_x_equipo.Fecha_UltAnu, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.MotiAnula, Fj_servindustrias.fa_registro_unidades_x_equipo.nom_pc, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.ip, Fj_servindustrias.fa_registro_unidades_x_equipo.Estado, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdEstadoRegistro_cat, dbo.fa_catalogo.Nombre AS nom_EstadoRegistro_cat, 
                         ...
                         dbo.tb_persona.pe_nombreCompleto AS nom_Cliente, dbo.vwct_periodo.smes, dbo.vwct_periodo.pe_FechaIni, dbo.vwct_periodo.pe_FechaFin, 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdRegistro
FROM            Fj_servindustrias.fa_registro_unidades_x_equipo INNER JOIN
                         dbo.fa_catalogo ON Fj_servindustrias.fa_registro_unidades_x_equipo.IdEstadoRegistro_cat = dbo.fa_catalogo.IdCatalogo INNER JOIN
                         ...
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdCentroCosto_sub_centro_costo = dbo.ct_centro_costo_sub_centro_costo.IdCentroCosto_sub_centro_costo INNER
                          JOIN
                         ...
                         dbo.vwct_periodo ON Fj_servindustrias.fa_registro_unidades_x_equipo.IdEmpresa = dbo.vwct_periodo.IdEmpresa AND 
                         Fj_servindustrias.fa_registro_unidades_x_equipo.IdPeriodo = dbo.vwct_periodo.IdPeriodo
GO
