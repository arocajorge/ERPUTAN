...
SELECT        Fj_servindustrias.fa_tarifario_facturacion_x_cliente_det_x_ActivoFijo.IdEmpresa, Fj_servindustrias.fa_tarifario_facturacion_x_cliente_det_x_ActivoFijo.IdTarifario, 
                         ...
                         Fj_servindustrias.fa_tarifario_facturacion_x_cliente_det_x_ActivoFijo.Unidades_minimas, dbo.Af_Activo_fijo.Af_Nombre, dbo.Af_Activo_fijo.CodActivoFijo, 
                         dbo.Af_Activo_fijo.IdUnidadFact_cat, dbo.Af_Catalogo.Descripcion, dbo.Af_Activo_fijo_Categoria.IdCategoriaAF, 
                         dbo.Af_Activo_fijo_Categoria.Descripcion AS Categoria, dbo.Af_Activo_fijo_Categoria.CodCategoriaAF, dbo.Af_Activo_fijo_Categoria.IdActivoFijoTipo, 
...
FROM            Fj_servindustrias.fa_tarifario_facturacion_x_cliente_det_x_ActivoFijo INNER JOIN
                         ...
                         dbo.Af_Activo_fijo.IdCategoriaAF = dbo.Af_Activo_fijo_Categoria.IdCategoriaAF LEFT OUTER JOIN
