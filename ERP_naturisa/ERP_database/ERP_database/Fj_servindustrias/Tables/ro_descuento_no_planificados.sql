CREATE TABLE [Fj_servindustrias].[ro_descuento_no_planificados] (
    ...
    CONSTRAINT [FK_ro_descuento_no_planificados_ro_empleado_x_ro_tipoNomina] FOREIGN KEY ([IdEmpresa], [IdEmpleado], [IdNomina_Tipo]) REFERENCES [dbo].[ro_empleado_x_ro_tipoNomina] ([IdEmpresa], [IdEmpleado], [IdTipoNomina])
);
