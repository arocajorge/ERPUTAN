						...
						BEGIN
								...
								where exists(
										...
										AND REV.IdNumMovi_inv = ct.IdNumMovi
												...
												END
								--BORRO TABLA DE MOVIMIENTO X ITEM			
								DELETE in_movi_inve_detalle_x_item
								WHERE EXISTS(
									SELECT REV.IdEmpresa_inv FROM in_spSys_inv_Reversar_aprobacion_in_movi_inven REV
									WHERE REV.IdEmpresa_inv = in_movi_inve_detalle_x_item.IdEmpresa
									AND REV.IdSucursal_inv = in_movi_inve_detalle_x_item.IdSucursal
									AND REV.IdBodega_inv = in_movi_inve_detalle_x_item.IdBodega
									AND REV.IdMovi_inven_tipo_inv = in_movi_inve_detalle_x_item.IdMovi_inven_tipo
									AND REV.IdNumMovi_inv = in_movi_inve_detalle_x_item.IdNumMovi
								)	
