CREATE TABLE [dbo].[in_transferencia_det] (
    ...
    [pr_descripcion]                 VARCHAR (MAX)  NULL,
    [dt_cantidad]                    FLOAT (53)     NOT NULL,
    [dt_cantidadPreDespacho]         FLOAT (53)     NULL,
    [dt_cantidadApro]                FLOAT (53)     NOT NULL,
    [dt_cantidadFinal]               FLOAT (53)     NOT NULL,
