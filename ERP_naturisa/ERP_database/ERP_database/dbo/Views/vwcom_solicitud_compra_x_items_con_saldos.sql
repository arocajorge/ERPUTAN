...
SELECT SC.IdEmpresa, SC.IdSucursal, SC.IdSolicitudCompra, SC.NumDocumento, SC.IdSolicitante AS IdPersona_Solicita, SC.IdDepartamento, SC.fecha, SC.plazo, SC.fecha_vtc, SC.observacion, SC.Estado, sucu.Su_Descripcion AS Sucursal, 
                  ...
                  dbo.com_solicitud_compra_det_aprobacion.do_precioCompra, dbo.com_solicitud_compra_det_aprobacion.do_porc_des, dbo.com_solicitud_compra_det_aprobacion.do_descuento, 
...
FROM     dbo.com_comprador RIGHT OUTER JOIN
                  ...
                  dbo.com_departamento ON SC.IdDepartamento = dbo.com_departamento.IdDepartamento AND SC.IdEmpresa = dbo.com_departamento.IdEmpresa INNER JOIN
                  ...
                  dbo.com_solicitud_compra_det.IdEmpresa = dbo.com_solicitud_compra_det_aprobacion.IdEmpresa AND dbo.com_solicitud_compra_det.IdSucursal = dbo.com_solicitud_compra_det_aprobacion.IdSucursal_SC AND 
                  dbo.com_solicitud_compra_det.IdSolicitudCompra = dbo.com_solicitud_compra_det_aprobacion.IdSolicitudCompra AND 
                  dbo.com_solicitud_compra_det.Secuencia = dbo.com_solicitud_compra_det_aprobacion.Secuencia_SC LEFT OUTER JOIN
                  ...
                  dbo.vwcom_solicitud_compra_det_x_Orden_Compra ON dbo.com_solicitud_compra_det.IdEmpresa = dbo.vwcom_solicitud_compra_det_x_Orden_Compra.scd_IdEmpresa AND 
                  ...
                  dbo.vwcom_ordencompra_local_det_x_cant_pedida_solic_compra ON dbo.com_solicitud_compra_det.IdEmpresa = dbo.vwcom_ordencompra_local_det_x_cant_pedida_solic_compra.scd_IdEmpresa AND 
