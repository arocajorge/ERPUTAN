...
SELECT        SC.IdEmpresa, SC.IdSucursal, SC.IdSolicitudCompra, SC.NumDocumento, SC.IdSolicitante AS IdPersona_Solicita, SC.IdDepartamento, SC.fecha, SC.plazo, 
                         ...
                         dbo.com_solicitud_compra_det.IdUnidadMedida, SC.IdComprador, dbo.com_comprador.Descripcion AS Comprador, dbo.in_Producto.pr_ManejaIva, 
                         ...
                         dbo.vwin_Producto_Stock_x_Sucursal.Stock
