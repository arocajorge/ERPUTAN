CREATE VIEW [dbo].[vwcp_orden_pago_det_con_cta_acreedora]
AS
SELECT dbo.cp_orden_pago_det.IdEmpresa, dbo.cp_orden_pago_det.IdOrdenPago, dbo.cp_orden_pago_det.Secuencia, dbo.cp_orden_pago_det.IdEmpresa_cxp, dbo.cp_orden_pago_det.IdCbteCble_cxp, dbo.cp_orden_pago_det.IdTipoCbte_cxp, 
