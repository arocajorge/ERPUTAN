...
SELECT        dbo.ba_Cbte_Ban.IdEmpresa, TipCbB.CodTipoCbteBan AS Tipo_Cbte, dbo.ba_Cbte_Ban.IdCbteCble AS Num_Cbte, ban.IdBanco, ban.ba_descripcion AS Banco, 
                         ...
                         CASE WHEN TipCbB.CodTipoCbteBan = 'CHEQ' THEN opCan.MontoAplicado WHEN TipCbB.CodTipoCbteBan = 'NDBA' THEN opCan.MontoAplicado WHEN TipCbB.CodTipoCbteBan
                          = 'NCBA' THEN 0 WHEN TipCbB.CodTipoCbteBan = 'DEPO' THEN 0 END AS haber, opCan.MontoAplicado AS saldo, dbo.ba_Cbte_Ban.cb_Valor AS Valor, 
                         dbo.ba_Cbte_Ban.cb_Cheque AS Cheque, dbo.ba_Cbte_Ban.cb_giradoA AS Chq_Girado_A, dbo.ba_Cbte_Ban.IdPersona_Girado_a AS IdPersona_Girado_a, 
                         TPF.IdTipoFlujo, TPF.Descricion AS Tipo_Flujo, tipN.IdTipoNota, tipN.Descripcion AS Tipo_Nota, dbo.ba_Cbte_Ban.PosFechado AS Fch_PostFechado, 
...
FROM            dbo.ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo INNER JOIN
                         ...
                         dbo.ba_TipoFlujo AS TPF ON dbo.ba_Cbte_Ban.IdEmpresa = TPF.IdEmpresa AND 
                         dbo.ba_Cbte_Ban.IdTipoFlujo = TPF.IdTipoFlujo
/*WHERE        (TipCbB.CodTipoCbteBan = 'CHEQ')*/ UNION
SELECT        dbo.ba_Cbte_Ban.IdEmpresa, dbo.ba_Cbte_Ban_tipo.CodTipoCbteBan AS Tipo_Cbte, dbo.ba_Cbte_Ban.IdCbteCble AS Num_Cbte, dbo.ba_Banco_Cuenta.IdBanco, 
                         ...
                         dbo.ba_Cbte_Ban.cb_Valor AS saldo, dbo.ba_Cbte_Ban.cb_Valor AS Valor, dbo.ba_Cbte_Ban.cb_Cheque AS Cheque, dbo.ba_Cbte_Ban.cb_giradoA AS Chq_Girado_A, 
                         dbo.ba_Cbte_Ban.IdPersona_Girado_a AS IdPersona_Girado_a, dbo.ba_TipoFlujo.IdTipoFlujo, dbo.ba_TipoFlujo.Descricion AS Tipo_Flujo, 
                         dbo.ba_tipo_nota.IdTipoNota, dbo.ba_tipo_nota.Descripcion AS Tipo_Nota, dbo.ba_Cbte_Ban.PosFechado AS Fch_PostFechado, 
                         CASE dbo.ba_Cbte_Ban.cb_ChequeImpreso WHEN 'S' THEN 'Impreso' ELSE 'No Impreso' END AS Es_Chq_Impreso, 
