...
SELECT     dbo.com_ordencompra_local.IdEmpresa, dbo.com_ordencompra_local.IdSucursal, dbo.com_ordencompra_local.IdOrdenCompra, 
                      ...
                      dbo.in_Producto.pr_precio_publico, dbo.in_Producto.pr_precio_mayor, dbo.in_Producto.pr_precio_minimo, dbo.in_Producto.pr_precio_puerta, CAST(0 AS float) 
                      AS pr_stock, CAST(0 AS float) AS pr_pedidos, dbo.in_Producto.pr_ManejaIva, dbo.in_Producto.pr_ManejaSeries, dbo.in_Producto.pr_costo_fob, 
                      dbo.in_Producto.pr_costo_CIF, dbo.in_Producto.pr_costo_promedio, NULL AS IdCtaCble_Vta, NULL AS IdCtaCble_CosBaseIva, NULL AS IdCtaCble_CosBase0, NULL 
                      ...
                      dbo.in_Producto.pr_peso, dbo.in_Producto.pr_profundidad, dbo.in_Producto.pr_stock_minimo, dbo.in_Producto.pr_stock_maximo
