...
AS
SELECT OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.oc_fecha, OC.oc_observacion, OC.IdEstadoAprobacion_cat, OC.Estado, Prov.IdProveedor, Prov.pr_nombre AS nom_proveedor, Prod.IdProducto, Prod.pr_codigo AS cod_producto, 
                  Prod.pr_descripcion AS nom_producto, OC_det.do_Cantidad, OC_det.do_precioCompra, OC_det.do_subtotal, dbo.tb_sucursal.Su_Descripcion, OC.oc_NumDocumento, OC_det.Secuencia, 
                  dbo.in_Guia_x_traspaso_bodega_det.Cantidad_enviar, dbo.in_Guia_x_traspaso_bodega_det.observacion AS observacion_det_gui, dbo.in_Guia_x_traspaso_bodega_det.IdGuia, OC.oc_fechaVencimiento, 
                  dbo.in_Guia_x_traspaso_bodega_det.Referencia, dbo.ct_punto_cargo.nom_punto_cargo
FROM     dbo.com_ordencompra_local AS OC INNER JOIN
                  ...
                  OC_det.IdOrdenCompra = dbo.in_Guia_x_traspaso_bodega_det.IdOrdenCompra_OC AND OC_det.Secuencia = dbo.in_Guia_x_traspaso_bodega_det.Secuencia_OC LEFT OUTER JOIN
