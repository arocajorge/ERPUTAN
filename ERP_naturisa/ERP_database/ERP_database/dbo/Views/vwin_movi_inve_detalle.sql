/*-   select * from vwin_movi_inve_detalle*/
CREATE VIEW dbo.vwin_movi_inve_detalle
AS
SELECT        C.IdEmpresa, C.IdSucursal, C.IdBodega, C.IdMovi_inven_tipo, C.IdNumMovi, C.Secuencia, C.mv_tipo_movi, C.IdProducto, C.dm_cantidad, C.dm_stock_ante, 
