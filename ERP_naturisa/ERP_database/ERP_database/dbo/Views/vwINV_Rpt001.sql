...
AS
SELECT        dbo.in_Ing_Egr_Inven.IdEmpresa, dbo.in_Ing_Egr_Inven.IdSucursal, dbo.in_Ing_Egr_Inven.IdBodega, dbo.in_Ing_Egr_Inven.IdMovi_inven_tipo, dbo.in_Ing_Egr_Inven.IdNumMovi, 
                         ...
                         dbo.in_Ing_Egr_Inven_det.IdProducto, dbo.in_Ing_Egr_Inven_det.dm_cantidad AS Cantidad, dbo.in_Ing_Egr_Inven_det.dm_stock_ante AS Stock_Ant, dbo.in_Ing_Egr_Inven_det.dm_stock_actu AS Stock_Act, 
                         dbo.in_Ing_Egr_Inven_det.dm_observacion AS Observacion_det, dbo.in_Ing_Egr_Inven_det.IdCentroCosto, dbo.in_Ing_Egr_Inven_det.IdCentroCosto_sub_centro_costo, 
                         dbo.in_Ing_Egr_Inven_det.IdEstadoAproba, dbo.in_Ing_Egr_Inven_det.IdUnidadMedida, dbo.in_Ing_Egr_Inven.cm_observacion AS Observacion, dbo.in_Ing_Egr_Inven.cm_fecha AS Fecha, 
...
FROM            dbo.in_UnidadMedida RIGHT OUTER JOIN
                         ...
                         dbo.in_Ing_Egr_Inven.IdNumMovi = dbo.in_Ing_Egr_Inven_det.IdNumMovi AND dbo.in_Ing_Egr_Inven.IdMovi_inven_tipo = dbo.in_Ing_Egr_Inven_det.IdMovi_inven_tipo ON 
