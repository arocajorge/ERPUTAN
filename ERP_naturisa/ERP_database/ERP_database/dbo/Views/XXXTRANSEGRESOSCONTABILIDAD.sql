CREATE VIEW XXXTRANSEGRESOSCONTABILIDAD
AS
...
FROM            in_Ing_Egr_Inven_det INNER JOIN
                         ...
                         in_Ing_Egr_Inven_det.IdNumMovi_inv = in_movi_inve_x_ct_cbteCble.IdNumMovi INNER JOIN
                         in_transferencia ON in_Ing_Egr_Inven.IdEmpresa = in_transferencia.IdEmpresa_Ing_Egr_Inven_Destino AND in_Ing_Egr_Inven.IdSucursal = in_transferencia.IdSucursal_Ing_Egr_Inven_Destino AND 
                         in_Ing_Egr_Inven.IdMovi_inven_tipo = in_transferencia.IdMovi_inven_tipo_SucuDest AND in_Ing_Egr_Inven.IdNumMovi = in_transferencia.IdNumMovi_Ing_Egr_Inven_Destino LEFT OUTER JOIN
