...
SELECT        SucuOrig.Su_Descripcion AS SucuOrigen, bodegaOri.bo_Descripcion AS BodegaORIG, sucuDest.Su_Descripcion AS SucuDEST, bodegaDes.bo_Descripcion AS BodegDest, dbo.in_transferencia.IdEmpresa, 
                         ...
                         dbo.in_transferencia.IdGuia, dbo.in_transferencia.EstadoRevision, dbo.in_transferencia.IdUsuarioRevision, dbo.in_transferencia.FechaRevision, dbo.in_transferencia.TuvoError
...
GROUP BY SucuOrig.Su_Descripcion, bodegaOri.bo_Descripcion, sucuDest.Su_Descripcion, bodegaDes.bo_Descripcion, dbo.in_transferencia.IdEmpresa, dbo.in_transferencia.IdSucursalOrigen, dbo.in_transferencia.IdBodegaOrigen, 
                         ...
                         dbo.in_transferencia.EstadoRevision, dbo.in_transferencia.IdUsuarioRevision, dbo.in_transferencia.FechaRevision, dbo.in_transferencia.TuvoError
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[42] 4[39] 2[3] 3) )"
      End
      ...
      Begin Tables = 
         ...
         Begin Table = "in_transferencia"
            Begin Extent = 
               ...
               Right = 897
            End
            DisplayFl', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwin_Transferencias';
