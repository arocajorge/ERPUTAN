...
SELECT dbo.cp_orden_giro.IdEmpresa, NULL AS IdOrdenPago, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, 'FACT' AS cod_tipo_doc, 'Factura' AS tipo_doc, 
                  'FAC#' + cast(cast(dbo.cp_orden_giro.co_factura AS numeric) AS varchar(20)) AS Documento, cast(dbo.cp_orden_giro.co_fechaOg as date) AS Fecha, cast(dbo.cp_orden_giro.co_FechaFactura_vct as date) co_FechaFactura_vct, dbo.cp_orden_giro.co_observacion AS Observacion, 
...
SELECT dbo.cp_nota_DebCre.IdEmpresa, NULL AS IdOrdenPago, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, '05', 'ND' AS cod_tipo_doc, 'Nota de débito' AS tipo_doc, 
                  ...
                  cast( dbo.cp_nota_DebCre.cn_fecha as date) AS Fecha, cast( dbo.cp_nota_DebCre.cn_Fecha_vcto as date) cn_Fecha_vcto, dbo.cp_nota_DebCre.cn_observacion AS Observacion, dbo.cp_proveedor.IdPersona, dbo.cp_proveedor.IdProveedor, 
...
UNION
SELECT A.IdEmpresa, A.IdOrdenPago, NULL AS IdCbteCble_Ogiro, NULL AS IdTipoCbte_Ogiro, NULL AS IdOrden_giro_Tipo, A.IdTipo_op, A.IdTipo_op, 'OP#:' + cast(A.IdOrdenPago AS varchar(20)), cast(A.Fecha as date), cast(A.Fecha_Pago as date), A.Observacion, 
