...
AS
SELECT        dbo.ba_Cbte_Ban.IdEmpresa, dbo.ba_Cbte_Ban.IdCbteCble, dbo.ba_Cbte_Ban.IdTipocbte, dbo.ba_Cbte_Ban.Cod_Cbtecble, dbo.ba_Cbte_Ban.cb_Observacion, dbo.ba_Cbte_Ban.cb_secuencia, 
                         dbo.ba_Cbte_Ban.cb_Valor, dbo.ba_Cbte_Ban.cb_Cheque, dbo.ba_Cbte_Ban.cb_ChequeImpreso, dbo.ba_Cbte_Ban.cb_FechaCheque, dbo.ba_Cbte_Ban.Fecha_Transac, dbo.ba_Cbte_Ban.Estado, 
                         dbo.ba_Cbte_Ban.cb_giradoA, dbo.ba_Cbte_Ban.cb_ciudadChq, dbo.ba_Cbte_Ban_tipo.CodTipoCbteBan, dbo.ba_Cbte_Ban.cb_Fecha, dbo.ct_cbtecble.cb_Fecha AS con_Fecha, 
                         dbo.ct_cbtecble.cb_Valor AS con_Valor, dbo.ct_cbtecble.cb_Observacion AS con_Observacion, dbo.ct_cbtecble.IdCbteCble AS con_IdCbteCble, dbo.ct_cbtecble_det.IdCtaCble, dbo.ct_plancta.pc_Cuenta, 
...
FROM            dbo.ct_cbtecble_det INNER JOIN
                         ...
                         dbo.ba_Cbte_Ban_tipo ON dbo.ba_Cbte_Ban_tipo_x_ct_CbteCble_tipo.CodTipoCbteBan = dbo.ba_Cbte_Ban_tipo.CodTipoCbteBan ON dbo.ct_cbtecble.IdEmpresa = dbo.ba_Cbte_Ban.IdEmpresa AND 
                         dbo.ct_cbtecble.IdTipoCbte = dbo.ba_Cbte_Ban.IdTipocbte AND dbo.ct_cbtecble.IdCbteCble = dbo.ba_Cbte_Ban.IdCbteCble INNER JOIN
