...
SELECT        dbo.com_solicitud_compra.IdEmpresa, dbo.com_solicitud_compra.IdSucursal, dbo.com_solicitud_compra.IdSolicitudCompra, 
                         ...
                         dbo.com_solicitud_compra_det.do_Cantidad, dbo.com_departamento.nom_departamento AS nom_departamento, dbo.com_solicitud_compra.IdSolicitante IdPersona_Solicita, 
...
FROM            dbo.com_solicitud_compra INNER JOIN
                         ...
                         dbo.com_departamento ON dbo.com_solicitud_compra.IdEmpresa = dbo.com_departamento.IdEmpresa AND 
                         dbo.com_solicitud_compra.IdDepartamento = dbo.com_departamento.IdDepartamento INNER JOIN
