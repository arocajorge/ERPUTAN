...
SELECT dbo.in_transferencia_det.IdEmpresa, dbo.in_transferencia_det.IdSucursalOrigen, dbo.in_transferencia_det.IdBodegaOrigen, dbo.in_transferencia_det.IdTransferencia, dbo.in_transferencia_det.dt_secuencia, 
                  dbo.in_transferencia_det.IdProducto, dbo.in_Producto.pr_codigo, CASE WHEN in_transferencia_det.IdProducto IS NULL THEN in_transferencia_det.pr_descripcion ELSE dbo.in_Producto.pr_descripcion END AS pr_descripcion , dbo.in_transferencia_det.dt_cantidad, dbo.in_transferencia_det.IdUnidadMedida, 
...
FROM     dbo.in_transferencia INNER JOIN
                  ...
                  dbo.in_UnidadMedida ON dbo.in_transferencia_det.IdUnidadMedida = dbo.in_UnidadMedida.IdUnidadMedida LEFT OUTER JOIN
